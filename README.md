...
**Awesome Books** is a book list keeping application which stores and display books in the list. It stores data into the localStorage.
...
If you like this project please share it on social media with other community members.
...
I would like to thank my coding partner for being supportive during the whole session.
